//
//  TutorConfirmedApptsViewController.m
//  TutorAppCapstone
//
...
@implementation TutorConfirmedApptsViewController
...
- (void)viewDidLoad {
    ...
    [FBRequestConnection startForMeWithCompletionHandler:^(FBRequestConnection *connection, id result, NSError *fbError) {
        ...
        NSURL *url =[NSURL URLWithString:@"http://cgi.soic.indiana.edu/~team14/get_tutor_all_conf_appts.php"];
